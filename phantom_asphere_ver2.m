function phantom_asphere_ver2()%%%%%%%%%%%%%%one more thing!!! principle plane modification
...
w(4)=S4/4/NA*2;%why???
deviation=1;
while deviation>0.03
[C11,C21,t1,C12,C22,t2,d,deviation]=thin_lens_thickning_spherical_coma_m2(ua,ua_,ub,ub_,ya,ya_,yb,yb_,n,w_expect,NA);
end
